...
export class _Blank extends React.Component {
  ...
  state = {
    ...
    Radio_7: true,
    CheckBox_8: true,
    Datepicker_11: new Date("06/25/2020")
  }
  ...
  render = () => (
    ...
    >
      <Image
        ...
        source={{
          uri:
            "https://d3nfddh2sbo9hk.cloudfront.net/media/project_component_resources/Hydrangeas_iwX6JrM.jpg"
        }}
        style={{
          width: 99,
          height: 99,
      ...
      <Radio
        ...
        checked={this.state.Radio_7}
        onChange={nextChecked => this.setState({ Radio_7: nextChecked })}
      />
      <CheckBox
        text="Checkbox"
        disabled={false}
      ...
      <Datepicker
        ...
        onSelect={nextValue => this.setState({ Datepicker_11: nextValue })}
      />
    </View>
  )
}
